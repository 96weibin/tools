...
## webpack
    ...
    自身职能对json、js进行打包，通过loader、plugin的使用实现对各中资源的打包
...
```shell
$ webpack ./index.js -o ./build/bundle.js --mode=development
# 将index.js编译到bundle.js
```
    ...
    module:{
        rules:[
             {   
                ...
                //eslint-config-airbnb-base //使用airbnb风格指南需要以上插件
...
3. 打包图片 url-loader
    依赖于file-loader  还需要-D 安装file-loader
